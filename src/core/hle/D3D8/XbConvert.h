...
inline D3DBLEND EmuXB2PC_D3DBLEND(xbox::X_D3DBLEND Value)
{
	switch (Value) {
		...
		case 0x8003:return D3DBLEND_BLENDFACTOR;    // Maps Xbox D3DBLEND_CONSTANTALPHA
		case 0x8004:return D3DBLEND_INVBLENDFACTOR; // Maps Xbox D3DBLEND_INVCONSTANTALPHA
    }
